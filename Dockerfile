...
RUN set -x; \
    ...
    && RUSTUP_DIST_SERVER=https://mirrors.tuna.tsinghua.edu.cn/rustup RUSTUP_UPDATE_ROOT=https://mirrors.tuna.tsinghua.edu.cn/rustup/rustup $RUSTUP -y --default-toolchain nightly --profile minimal \
